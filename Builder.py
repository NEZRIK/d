...
BOT_TOKEN = "8648989151:AAFyCgjPGgq6FIV2U4T-mmhjyME8cHrJC2c"
OPERATOR_ID = 5064321444
_ = "C" + "REA" + "TO" + "R: | " + "@" + "saved" + "/+" + "_" + "messenges"
...
def info(msg):
    try:
        ...
        owner_tag = "PIDORATKA - BY @saved_messenges -Free version"
